...
public class Stateful {
     ...
     * Every request afterwards uses that session ID (cookie) to identify you.
     */
     ...
     * Server expects it as a cookie (server-side session) and will use it to look up the sessio
     */
